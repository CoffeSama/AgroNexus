...
class ProduccionController extends Controller
{
    ...
    {
        $producciones = Produccion::with(['lote', 'destino'])
    ...
    public function create()
    {
        ...
        return view('producciones.create', compact('lotes', 'destinos'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('producciones.index')->with('success', 'Producción creada.');
    }
    ...
    public function edit(Produccion $produccion)
    {
        ...
        return view('producciones.edit', compact('produccion', 'lotes', 'destinos'));
    }
    ...
    public function update(Request $request, Produccion $produccion)
    {
        ...
        return redirect()->route('producciones.index')->with('success', 'Producción actualizada.');
    }
    ...
    public function destroy(Produccion $produccion)
    {
        ...
        return redirect()->route('producciones.index')->with('success', 'Producción eliminada.');
    }
}