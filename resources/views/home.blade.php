...
<style>
    ...
    .small-box-green { background: linear-gradient(135deg, var(--success-color), #34ce57) !important; }
    .small-box-blue { background: linear-gradient(135deg, var(--info-color), #20c997) !important; }
    .small-box-yellow { background: linear-gradient(135deg, var(--warning-color), #ffca2c) !important; }
    .small-box-red { background: linear-gradient(135deg, var(--danger-color), #e74a3b) !important; }
    ...
    .recent-activity-item:hover { background: #f8f9fc; }
    ...
    .activity-icon.activity-siembra { background: var(--success-color); }
    .activity-icon.activity-riego { background: var(--info-color); }
    .activity-icon.activity-cosecha { background: var(--warning-color); }
    .activity-icon.activity-fumigacion { background: var(--danger-color); }
    .activity-icon.activity-labranza { background: #6c757d; }

    .activity-info h6 { margin: 0; font-weight: 600; color: var(--text-dark); }
    ...
    .weather-widget .weather-temp { font-size: 48px; font-weight: 300; margin: 10px 0; }
    .weather-widget .weather-desc { opacity: 0.9; margin-bottom: 15px; }
    .weather-details { display: flex; justify-content: space-between; font-size: 14px; }
    ...
    .alert-content h6 { margin: 0; font-size: 14px; font-weight: 600; }
    .alert-content small { color: var(--text-light); font-size: 12px; }

    .production-chart-container { position: relative; height: 300px; }

    .progress-group { margin-bottom: 15px; }
    .progress-group .progress { height: 8px; border-radius: 4px; }

    .description-block { text-align: center; padding: 15px 0; }
    .description-header { font-size: 1.5rem; font-weight: 600; margin: 5px 0; }
    .description-text { font-size: 12px; color: var(--text-light); text-transform: uppercase; }
    .description-percentage { font-size: 12px; font-weight: 600; }
</style>
@endpush
...
<div class="row">
    ...
    <div class="col-lg-3 col-6">
        <div class="small-box small-box-blue">
            <div class="inner">
                <h3>{{ number_format($stats['produccion_mes_kg'] ?? 0, 0) }}<span style="font-size: 20px;">kg</span></h3>
    ...
    <div class="col-md-4">
        ...
        <div class="card">
            ...
            <div class="card-body quick-actions">
                ...
                <a href="{{ route('ventas.index') }}" class="btn btn-warning btn-block">
                ...
                @forelse($actividadesRecientes as $act)
                    ...
                    <div class="recent-activity-item">
                        ...
                        <div class="activity-info">
                            <h6>{{ $act->tipoActividad->nombre ?? 'Actividad' }} - {{ $act->lote->nombre ?? 'Sin lote' }}</h6>
                            <small>{{ $act->fechainicio ? \Carbon\Carbon::parse($act->fechainicio)->diffForHumans() : '' }} • Por {{ $act->usuario->nombre ?? 'Usuario' }}</small>
                        </div>
                    </div>
                @empty
