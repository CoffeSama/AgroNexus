...
<style>
    .catalog-header {
        ...
        margin-bottom: 25px; box-shadow: 0 4px 15px rgba(253, 126, 20, 0.3);
    }
    ...
    .item-card {
        ...
        transition: all 0.3s ease; overflow: hidden; border-left: 4px solid #fd7e14;
    }
    ...
    .search-box input:focus { border-color: #fd7e14; box-shadow: 0 0 0 3px rgba(253, 126, 20, 0.1); }
            ...
            <div class="card-body">
                <div class="item-info">
                    ...
                    <div class="item-details">
                        <h5>{{ $tipo->nombre }}</h5>
                        <small><i class="fas fa-hashtag mr-1"></i>ID: {{ $tipo->tipoinsumoid }}</small>
                    </div>
                </div>
                <div class="item-actions">
                    <a href="{{ route('tipo-insumos.edit', $tipo) }}" class="btn btn-warning btn-sm"><i class="fas fa-edit"></i></a>
    ...
    @empty
        <div class="item-card">
            <div class="empty-state">
                ...
                <a href="{{ route('tipo-insumos.create') }}" class="btn btn-warning"><i class="fas fa-plus mr-2"></i>Agregar Tipo</a>
            </div>
        </div>
    @endforelse
</div>

@if($tipoInsumos->hasPages())<div class="d-flex justify-content-center mt-4">{{ $tipoInsumos->links() }}</div>@endif
