...
<style>
    ...
    .search-box input {
        ...
        border: 2px solid #e9ecef; height: 50px; font-size: 1rem;
    }
    .search-box input:focus { border-color: #28a745; box-shadow: 0 0 0 3px rgba(40, 167, 69, 0.1); }
            ...
            <div class="card-body">
                <div class="item-info">
                    ...
                    <div class="item-details">
                        ...
                        <small><i class="fas fa-hashtag mr-1"></i>ID: {{ $cultivo->cultivoid }}</small>
                    </div>
                </div>
    ...
    @empty
        <div class="item-card">
            <div class="empty-state">
                ...
                <a href="{{ route('cultivos.create') }}" class="btn btn-success"><i class="fas fa-plus mr-2"></i>Agregar Cultivo</a>
            </div>
        </div>
    @endforelse
</div>
...
<div class="mt-4">
    <a href="{{ route('catalogos.index') }}" class="btn btn-outline-secondary"><i class="fas fa-arrow-left mr-2"></i>Volver a Catálogos</a>
</div>
@endsection
