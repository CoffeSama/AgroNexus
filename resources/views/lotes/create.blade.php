            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="nombre" class="form-control" maxlength="100" required placeholder="Ej: Lote Norte" value="{{ old('nombre') }}">
                    </div>

                    <div class="form-group">
                        <label><i class="fas fa-map-marker-alt mr-1"></i> Ubicacion (texto)</label>
                        <input type="text" name="ubicacion" class="form-control" maxlength="200" placeholder="Ej: Km 5 Carretera Norte" value="{{ old('ubicacion') }}">
                    </div>

                    <div class="form-group">
                        <label><i class="fas fa-ruler-combined mr-1"></i> Superficie (hectareas) <span class="text-danger">*</span></label>
                        <input type="number" step="0.01" name="superficie" id="superficie" class="form-control" min="0" required placeholder="Ej: 15.5" value="{{ old('superficie') }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="input-group">
                            ...
                            <div class="input-group-append">
                                <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modalCultivo">
                    ...
                    <div class="form-group">
                        ...
                        <select name="estadolotetipoid" class="form-control">
                            ...
                            @foreach($estados as $e)
                                <option value="{{ $e->estadolotetipoid }}" {{ $e->nombre == 'disponible' ? 'selected' : '' }}>{{ ucfirst($e->nombre) }}</option>
                            @endforeach
                        </select>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="image-upload-container" onclick="document.getElementById('imagen').click();">
                            ...
                            <p class="mb-1">Haz clic aqui para seleccionar una imagen</p>
                ...
                <div class="col-md-6">
                    ...
                    <div class="form-row">
                        <div class="form-group col-md-6">
                            <label>Latitud</label>
                            <input type="number" step="0.0000001" name="latitud" id="latitud" class="form-control" min="-90" max="90" value="{{ old('latitud') }}" placeholder="-17.7833">
                        </div>
                        <div class="form-group col-md-6">
                            <label>Longitud</label>
                            <input type="number" step="0.0000001" name="longitud" id="longitud" class="form-control" min="-180" max="180" value="{{ old('longitud') }}" placeholder="-63.1821">
                        </div>
                    </div>

                    <div class="alert alert-info small">
                        <i class="fas fa-info-circle mr-1"></i> El mapa esta centrado en Santa Cruz, Bolivia. Haz clic para marcar la ubicacion.
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="btnGuardarCultivo"><i class="fas fa-save mr-1"></i> Guardar</button>
            </div>
        </div>
    </div>
</div>
