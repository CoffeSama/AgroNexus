...
<style>
    ...
    .small-box-act-total { background: linear-gradient(135deg, #6f42c1, #9775fa) !important; }
    .small-box-act-done { background: linear-gradient(135deg, #28a745, #20c997) !important; }
    .small-box-act-pending { background: linear-gradient(135deg, #fd7e14, #ffc107) !important; }
    .small-box-act-lotes { background: linear-gradient(135deg, #17a2b8, #6dd5ed) !important; }
    ...
    .badge-pendiente { background: #ffc107; color: #1a252f; }
    .badge-en-progreso { background: #17a2b8; color: white; }
</style>
@endpush
                    ...
                    <table id="actividadesTable" class="table table-striped table-hover">
                        ...
                        <tbody>
                            @foreach($actividades as $act)
                                ...
                                @endphp
                                <tr>
                                    <td>{{ $act->fechainicio instanceof \Carbon\Carbon ? $act->fechainicio->format('d/m/Y') : $act->fechainicio }}</td>
                                    <td>
