...
<style>
    ...
    .small-box-prod-total { background: linear-gradient(135deg, #fa8c16, #ffc53d) !important; }
    .small-box-prod-cosechas { background: linear-gradient(135deg, #52c41a, #73d13d) !important; }
    .small-box-prod-lotes { background: linear-gradient(135deg, #1890ff, #40a9ff) !important; }
    .small-box-prod-promedio { background: linear-gradient(135deg, #722ed1, #9775fa) !important; }
                    ...
                    <table id="produccionTable" class="table table-striped table-hover">
                        ...
                        <tbody>
                            @foreach($producciones as $prod)
                                <tr>
                                    <td>{{ $prod->fechacosecha instanceof \Carbon\Carbon ? $prod->fechacosecha->format('d/m/Y') : $prod->fechacosecha }}</td>
