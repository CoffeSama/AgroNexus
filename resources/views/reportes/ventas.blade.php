...
<style>
    ...
    .small-box-ventas { background: linear-gradient(135deg, #28a745, #20c997) !important; }
    .small-box-cantidad { background: linear-gradient(135deg, #17a2b8, #6dd5ed) !important; }
    .small-box-trans { background: linear-gradient(135deg, #ffc107, #ffca2c) !important; }
    .small-box-precio { background: linear-gradient(135deg, #6f42c1, #9775fa) !important; }
                        ...
                        <tbody>
                            @foreach($ventas as $venta)
                                <tr>
                                    ...
                                    <td>{{ number_format($venta->cantidad, 2) }} {{ $venta->unidadMedida->abreviatura ?? 'kg' }}</td>
