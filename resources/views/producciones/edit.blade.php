        ...
        <div class="col-lg-9 col-md-8">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="date" name="fechacosecha" class="form-control" value="{{ $produccion->fechacosecha ? \Carbon\Carbon::parse($produccion->fechacosecha)->format('Y-m-d') : '' }}" required>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="col-md-4">
                        <div class="form-group">
                            ...
                            <div class="input-group">
                                <input type="number" step="0.01" name="cantidad" id="cantidad" class="form-control" min="0.01" value="{{ $produccion->cantidad }}" required>
                                <div class="input-group-append">
                                    <span class="input-group-text">{{ $produccion->unidadMedida->abreviatura ?? 'kg' }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="form-card">
                    ...
                    <div class="col-md-6">
                        @if($produccion->imagenurl)
                            <div class="text-center">
                                <img src="{{ asset($produccion->imagenurl) }}" alt="Imagen actual" style="max-height: 100px; border-radius: 8px;">
                            </div>
                        @endif
                    </div>
                </div>
                ...
                <div class="form-group mb-0">
                    ...
                    <textarea name="observaciones" class="form-control" rows="3" placeholder="Notas adicionales sobre la cosecha...">{{ $produccion->observaciones }}</textarea>
                </div>
            </div>
        </div>
        ...
        <div class="col-lg-3 col-md-4">
            ...
            <div class="form-card">
                ...
                <div class="cantidad-preview">
                    ...
                    <div class="amount" id="cantidad-preview">{{ number_format($produccion->cantidad ?? 0, 2) }} kg</div>
                </div>
