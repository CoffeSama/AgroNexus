...
<style>
    ...
    .produccion-body { padding: 15px 20px; }
    .produccion-info {
        display: flex;
        flex-wrap: wrap;
        gap: 20px;
    }
    .produccion-info-item { flex: 1; min-width: 120px; }
    ...
    .produccion-info-item span { font-weight: 600; color: #1a252f; }
    .produccion-footer {
        padding: 12px 20px;
        background: #f8f9fc;
        display: flex;
        ...
        <div class="produccion-card">
            ...
            <div class="produccion-body">
                <div class="produccion-info">
                    ...
                    <div class="produccion-info-item">
                        <label><i class="fas fa-hashtag mr-1"></i> ID</label>
                        <span>#{{ $p->produccionid }}</span>
                    </div>
                </div>
            </div>
            <div class="produccion-footer">
                ...
                <div>
                    ...
                    <form action="{{ route('producciones.destroy', $p) }}" method="POST" class="d-inline" onsubmit="return confirm('¿Eliminar?')">
                        @csrf
                        @method('DELETE')
