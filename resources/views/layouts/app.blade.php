    ...
    <div class="wrapper">
        ...
        <aside class="main-sidebar sidebar-dark-primary elevation-4">
            ...
            <a href="{{ route('dashboard') }}" class="brand-link">
                <img src="{{ asset('images/logo.png') }}" alt="AgroNexus Logo"
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                        ...
                        <li class="nav-item {{ request()->routeIs('producciones.*', 'climas.*') ? 'menu-open' : '' }}">
                            <a href="#"
                                class="nav-link {{ request()->routeIs('producciones.*', 'climas.*') ? 'active' : '' }}">
                        ...
                        <li
                            class="nav-item {{ request()->routeIs('insumos.*', 'lote-insumos.*', 'almacenes.*', 'producciones_almacenamiento.*') ? 'menu-open' : '' }}">
                            <a href="#"
                                class="nav-link {{ request()->routeIs('insumos.*', 'lote-insumos.*', 'almacenes.*', 'producciones_almacenamiento.*') ? 'active' : '' }}">
